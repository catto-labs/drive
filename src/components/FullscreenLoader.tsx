import { createSignal, type Component, createEffect, on, Show, onMount, onCleanup } from "solid-js";
...
export const FullscreenLoaderEntry: Component = () => {
  ...
  createEffect(on(loaderData, (data) => {
    if (endLoaderTimeout) {
  ...
  return (
    <Presence exitBeforeEnter>
      <Show when={showLoader()}>
        <Motion.div class="z-50 bg-surface0 fixed inset-0 flex items-center justify-center"
          initial={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        ...
        >
          ...
          <img
            ...
            classList={{ "-mt-48": loaderData().finished, "-mt-10": !loaderData().finished }}
          />
...
const FullscreenLoader: Component<{
  ...
  createEffect(on(() =>  props.message, (message) => {
